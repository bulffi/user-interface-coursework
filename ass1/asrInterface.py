...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btn_start_speaking = QPushButton(self)
        self.btn_start_speaking.setObjectName('start')
        self.btn_start_speaking.setText('CLICK TO START')
        self.btn_start_speaking.setStyleSheet("color: rgb(255,69,0);")
        self.btn_start_speaking.setFont(font)
        self.btn_start_speaking.setGeometry(QtCore.QRect(60,200,200,50))
